...
| # | Branch | Task | Status |
|---|--------|------|--------|
| 1 | `feat/set-global` | `SET GLOBAL` statement — write to global scope from inside SUB/FUNCTION | ✅ Complete — merged to `main` |
...
| 5 | `feat/2d-arrays` | 2D arrays — `DIM name[rows][cols] AS type`, read/write both dimensions | ✅ Complete — merged to `main` |
| 6 | `docs/v1-feature-sync` | Sync spec, samples (excl. Sunken Crown), and all learning docs to v1 feature set | 🔄 In progress |
